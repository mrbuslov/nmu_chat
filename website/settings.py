...
CHANNEL_LAYERS = { # ДЛЯ ДЕПЛОЯ ИСПОЛЬЗОВАТЬ REDIS НАСТРОЙКИ
    'default':{
        'BACKEND':'channels.layers.InMemoryChannelLayer'
    }
}

# https://stackoverflow.com/questions/51938792/websocket-with-django-channels-doesnt-work-connection-failed
